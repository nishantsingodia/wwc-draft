      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-400">{upcoming.length} upcoming matches</p>
          </div>
        </div>

        {upcoming.length === 0 ? (
          <p className="text-zinc-500 text-sm py-8 text-center">No upcoming matches.</p>
        ) : (
            ...
            {upcoming.map((m) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-zinc-500 text-sm shrink-0 ml-2">Draft →</span>
                </Link>
              );
            })}
          </div>
